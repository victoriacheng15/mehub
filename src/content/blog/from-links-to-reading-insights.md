...
*This is Part 2 of my journey building a Personal Reading Analytics Dashboard. Catch up on [Part 1 - From PIi to Cloud Automation](https://victoriacheng15.vercel.app/blog/from-pi-to-cloud-automation)*

## Article Extractor → Dashboard
...
That question sparked the next phase: building a personal reading analytics dashboard, powered entirely by open tools and zero infrastructure.
...
To answer these, I moved beyond raw data and built a metrics engine that computes reading progress, backlog aging, and source-level analytics. This engine powers a full dashboard with seven interactive visualizations—tracking everything from monthly trends to unread article age distribution—without relying on servers, databases, or paid infrastructure.
